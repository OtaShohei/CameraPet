...
public class CameraView02 extends SurfaceView {
	 ...
	 * @throws Exception
	 */
	public CameraView02(Context context, AttributeSet attrs, int defStyle)
			throws Exception {
		super(context, attrs, defStyle);
		init(context);
	}

	public CameraView02(Context context, AttributeSet attrs) throws Exception {
		super(context, attrs);
		init(context);
	}

	public CameraView02(Context context) throws Exception {
		super(context);
		init(context);
	}
