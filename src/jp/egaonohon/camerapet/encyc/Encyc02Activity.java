...
public class Encyc02Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc02CamPeAdMob = new CamPeAdMob();
			adView = encyc02CamPeAdMob.workAtOnCreate(this);
		} else {
			/** GameFeat呼び出し */
			CamPeGameFeat encyc02CamPeGameFeat = new CamPeGameFeat();
			encyc02CamPeGameFeat.workAtOnCreate(this);
		}
