...
public class Encyc03Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc03CamPeAdMob = new CamPeAdMob();
			adView = encyc03CamPeAdMob.workAtOnCreate(this);
		} else {
			 /** GameFeat呼び出し */
			 CamPeGameFeat encyc03CamPeGameFeat = new CamPeGameFeat();
			 encyc03CamPeGameFeat.workAtOnCreate(this);
		}
	...
	public void goHome(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc03Activity.this, MainActivity.class);
