...
public class Encyc04Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc04CamPeAdMob = new CamPeAdMob();
			adView = encyc04CamPeAdMob.workAtOnCreate(this);
		} else {
			 /** GameFeat呼び出し */
			 CamPeGameFeat encyc04CamPeGameFeat = new CamPeGameFeat();
			 encyc04CamPeGameFeat.workAtOnCreate(this);
		}
	...
	public void goHome(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc04Activity.this, MainActivity.class);
