...
public class Encyc05Activity extends Activity {
	...
	/** Logのタグを定数で確保 */
	private static final String TAG = "Encyc05";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.encyclopedia_fifth);
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc05CamPeAdMob = new CamPeAdMob();
			adView = encyc05CamPeAdMob.workAtOnCreate(this);
		} else {
			 /** GameFeat呼び出し */
			 CamPeGameFeat encyc05CamPeGameFeat = new CamPeGameFeat();
			 encyc05CamPeGameFeat.workAtOnCreate(this);
		}
	...
	public void goBack(View v) {
		 ...
		 */
		Intent intent = new Intent(Encyc05Activity.this, Encyc04Activity.class);
	...
	public void goHome(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc05Activity.this, MainActivity.class);
	...
	public void goforward(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc05Activity.this, Encyc06Activity.class);
