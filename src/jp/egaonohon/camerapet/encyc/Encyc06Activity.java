...
public class Encyc06Activity extends Activity {
	...
	/** Logのタグを定数で確保 */
	private static final String TAG = "Encyc06";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.encyclopedia_sixth);
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc06CamPeAdMob = new CamPeAdMob();
			adView = encyc06CamPeAdMob.workAtOnCreate(this);
		} else {
			 /** GameFeat呼び出し */
			 CamPeGameFeat encyc06CamPeGameFeat = new CamPeGameFeat();
			 encyc06CamPeGameFeat.workAtOnCreate(this);
		}
	...
	public void goBack(View v) {
		 ...
		 */
		Intent intent = new Intent(Encyc06Activity.this, Encyc05Activity.class);
	...
	public void goHome(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc06Activity.this, MainActivity.class);
	...
	public void goforward(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc06Activity.this, Encyc07Activity.class);
