...
public class Encyc08Activity extends Activity {
	...
	/** Logのタグを定数で確保 */
	private static final String TAG = "Encyc08";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.encyclopedia_eighth);
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc08CamPeAdMob = new CamPeAdMob();
			adView = encyc08CamPeAdMob.workAtOnCreate(this);
		} else {
			/** GameFeat呼び出し */
			CamPeGameFeat encyc08CamPeGameFeat = new CamPeGameFeat();
			encyc08CamPeGameFeat.workAtOnCreate(this);
		}
	...
	public void goBack(View v) {
		 ...
		 */
		Intent intent = new Intent(Encyc08Activity.this, Encyc07Activity.class);
	...
	public void goHome(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc08Activity.this, MainActivity.class);
	...
	public void goforward(View v) {
		 ...
		 * 画面移動要求を格納したインテントを作成する。 第一引数に自身(this)を設定 第二引数に移動先のクラス名を指定
		 */
		Intent intent = new Intent(Encyc08Activity.this, Encyc09Activity.class);
