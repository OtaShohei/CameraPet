...
public class Encyc09Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!locale.equals("ja_JP")) {
			/** AdMob呼び出し */
			CamPeAdMob encyc09CamPeAdMob = new CamPeAdMob();
			adView = encyc09CamPeAdMob.workAtOnCreate(this);
		} else {
			/** GameFeat呼び出し */
			CamPeGameFeat encyc09CamPeGameFeat = new CamPeGameFeat();
			encyc09CamPeGameFeat.workAtOnCreate(this);
		}
